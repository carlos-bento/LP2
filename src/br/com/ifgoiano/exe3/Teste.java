        ...
        try {
            for (int i = 0; i < numeros.size(); i++) {
                if (numeros.get(i).equals(numeros.lastIndexOf(i))) {
                    System.out.println("Os números " + numeros.get(i) + " e " + numeros.lastIndexOf(i) + " são iguais");
                } else {
                    System.out.println("Os números " + numeros.get(i) + " e " + numeros.lastIndexOf(i) + " são diferentes");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
