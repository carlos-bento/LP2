...
public class Teste {
    ...
    // 18. Fazer um programa que sorteie um número de 0 a 100 e peça para que o
    // usuário (sem conhecer o
    // número sorteado) tente acertar. Caso não acerte, o programa deve imprimir uma
    // mensagem informando se o
    // número sorteado é maior ou menor que a tentativa feita. Deixe que o usuário
    // tente até acertar o número e
