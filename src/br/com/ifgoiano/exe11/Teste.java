...
public class Teste {
    ...
    // 11. A Secretaria de Meio Ambiente que controla o índice de poluição mantém 3
    // grupos de indústrias que são
    // altamente poluentes do meio ambiente. O índice de poluição aceitável varia de
    // 0,05 até 0,25. Se o índice
    // sobe para 0,3 as indústrias do 1° grupo são intimadas a suspenderem suas
    // atividades, se o índice crescer
    // para 0,4 as indústrias do 1°o e 2° grupo são intimadas a suspenderem suas
    // atividades, se o índice atingir 0,5
    // todos os grupos devem ser notificados a paralisarem suas atividades. Faça um
    // programa que leia o índice
    // de poluição medido e emita a notificação adequada aos diferentes grupos de
    // empresas. O algoritmo só deve
    // parar de rodar quando o usuário responder "S" na seguinte pergunta, "Deseja
    // encerrar o programa?"
